...
public enum PreviewData {
  ...
  public static let activeMeeting = ZoomMeeting(
    id: UUID(),
  ...
  public static let upcomingMeeting = ZoomMeeting(
    id: UUID(),
  ...
  public static let endedMeeting = ZoomMeeting(
    id: UUID(),
  ...
  public static let meetingWithoutUrl = ZoomMeeting(
    id: UUID(),
  ...
  public static let longTitleMeeting = ZoomMeeting(
    id: UUID(),
    title:
  ...
  public static let minimalMeeting = ZoomMeeting(
    id: UUID(),
  ...
  public static let yesterdayMeetings: [ZoomMeeting] = [
    ZoomMeeting(
      id: UUID(),
  ...
  public static let todayMeetings: [ZoomMeeting] = [
    activeMeeting,
    upcomingMeeting,
    ZoomMeeting(
      id: UUID(),
  ...
  public static let tomorrowMeetings: [ZoomMeeting] = [
    ZoomMeeting(
      id: UUID(),
  ...
  public final class MockCalendarManager {
    ...
    public var tomorrowMeetings: [ZoomMeeting] { PreviewData.tomorrowMeetings }
